...
```{r setup Exercise 2.3}
    ...
    knitr::opts_knit$set(root.dir = normalizePath("~/2023-2024 USC/Spring 2024/QBIO 490/qbio_490_justinwang")) 
```
...
age <- 45
birthday <- "06/27/1979"
three_fave_colors <- c("Red", "Green", "Blue")

name                # string
age                 # numeric
birthday            # string
three_fave_colors   # vector of strings

typeof(name)
typeof(age)
typeof(birthday)
typeof(three_fave_colors)
```
...
```{r Exercise 9.4}
# write code here
mtcars_c <- mtcars[, -which(colnames(mtcars) == "am")]
```
